...
from employee import Employee  # needed for employee_id validation
...
class Review:
    ...
    def __init__(self, year, summary, employee_id, id=None):
        self.id = id
        self.year = year            # validated by property
        self.summary = summary      # validated by property
        self.employee_id = employee_id  # validated by property
    ...
    @classmethod
    def get_all_for_employee_id(cls, employee_id):
